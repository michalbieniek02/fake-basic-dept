...
document.addEventListener('scroll', () => {
    ...
    if (rect1.top <= 0 && rect1.bottom >= 0) {
        ...
        button1.classList.add('border-black','custom-shadow');
        button1.classList.remove('border-darkTxt','custom-shadow-dark');
        button2.classList.add('border-black','custom-shadow');
        button2.classList.remove('border-darkTxt','custom-shadow-dark');
        ...
        button1.classList.add('border-darkTxt','custom-shadow-dark');
        button1.classList.remove('border-black','custom-shadow');
        button2.classList.add('border-darkTxt','custom-shadow-dark');
        button2.classList.remove('border-black','custom-shadow');
